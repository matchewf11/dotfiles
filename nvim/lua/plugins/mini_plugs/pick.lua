...
-- <
-- ------------------------------------------------------------------------
-- MiniPick.setup {config tbl|nil} -- creates :Pick user cmd
--   -- :Pick files tool='git'
...
-- ------------------------------------------------------------------------------
-- MiniPick.default_match({stritems}, {inds}, {query}, {opts}) -- default match
--
...
--
-- ------------------------------------------------------------------------------
-- MiniPick.default_choose {item any} -- choose item
--
...
-- MiniPick.builtin.files({local_opts}, {opts}) -- pick from files (rg/fd/git/vim.fs.dir())
--  {local_opts}|nil options for particular picker
--    <tool> tool to use
--  {opts}|nil, options forwarded to |MiniPick.start()|
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- MiniPick.registry -- picker registry; call with |:Pick|
--
